# -----------------------------------------------------------
# В дальнейшем можно обернуть код в классы или функции.
# Мусорные заявки составляют 824 из 3337, что вносит
# существенный шум в данные, например шум в количество
# старых клиентов. Желательно их отфильтровать перед
# агрегацией.
# -----------------------------------------------------------
